...
import numpy as np
import pandas as pd
from dhanhq import marketfeed, MarketFeed
import time
import ast
...
def run_feed(dhan_context,dhan):
    ...
    try:
        ...
        # ✅ CHANGED: Use MarketFeed with dhan_context instead of DhanFeed
        ...
        while True:
            ...
            if refresh:  
                ...
                # Create new feed    
                #data = marketfeed.DhanFeed(clientid, accesstoken, prepared_instruments, version)
                # ✅ CHANGED: Create new feed with dhan_context
                data = MarketFeed(dhan_context, prepared_instruments, version)                
...
def main():
    ...
    """
    if len(sys.argv) < 2:
        print("Usage: python SparkLite_v6.py [dev|prod]")
        sys.exit(1)
