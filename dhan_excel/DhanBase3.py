    ...
    try:
        ...
        while True:
            ...
            if response['type'] == 'Ticker Data':
                ...
                if security_id in security_to_cell['crude_to_cell']:
                ...
                elif security_id in security_to_cell['nifty_to_cell']:
                ...
                elif security_id in security_to_cell['banknifty_to_cell']:   
